...
namespace RiskyMod
{
    public static class ConfigFiles
    {
        ...
        private static void ConfigGeneral()
        {
            ...
            AlliesCore.turretResistAOE = GeneralCfg.Bind(allyString, "Turrets Resist AoE", true, "Turret allies take significantly reduced damage from ALL AoE attacks.").Value;
