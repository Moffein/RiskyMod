...
namespace RiskyMod
{
    public static class ConfigFiles
    {
        ...
        private static void ConfigSurvivors()
        {
            ...
            CommandoCore.removePrimaryFalloff = SurvivorCfg.Bind(commandoString, "Double Tap - Remove Falloff", true, "Removes bullet falloff from this skill.").Value;
            ...
            CommandoCore.lightningRound = SurvivorCfg.Bind(commandoString, "Phase Lightning Secondary Skill", true, "Adds a new secondary skill.").Value;
