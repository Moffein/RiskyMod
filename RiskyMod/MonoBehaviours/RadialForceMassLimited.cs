...
namespace RiskyMod.MonoBehaviours
{
    ...
    public class RadialForceMassLimited : MonoBehaviour
    {
        ...
        public void Start()
        {
            LightningBoltRepeatComponent lrc = base.GetComponent<LightningBoltRepeatComponent>();
            if (lrc)
            {
                teamIndex = lrc.teamIndex;
            }
        ...
        public void SearchForTargets(List<HurtBox> dest)
        {
            ...
            this.sphereSearch.FilterCandidatesByHurtBoxTeam(TeamMask.GetEnemyTeams(teamIndex));
