...
namespace RiskyMod.Items.Uncommon
{
    public class Bandolier
    {
        ...
        public Bandolier()
        {
            ...
            LanguageAPI.Add("ITEM_BANDOLIER_DESC", "<style=cIsUtility>Reduce skill cooldowns</style> by <style=cIsUtility>10%</style>. <style=cIsUtility>18%</style> + <style=cStack>(10% on stack)</style> chance on kill to drop an ammo pack that <style=cIsUtility>resets all cooldowns</style>.");
        }
    }
}
