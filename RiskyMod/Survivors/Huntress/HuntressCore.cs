...
namespace RiskyMod.Survivors.Huntress
{
    public class HuntressCore
    {
        ...
        private void ModifySecondaries(SkillLocator sk)
        {
            ...
            sk.secondary.skillFamily.variants[0].skillDef.skillDescriptionToken = "HUNTRESS_SECONDARY_DESCRIPTION_RISKYMOD";
            sk.secondary.skillFamily.variants[0].skillDef.baseRechargeInterval = 4f;
